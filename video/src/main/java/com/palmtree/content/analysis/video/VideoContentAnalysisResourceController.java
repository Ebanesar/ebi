...
import com.palmtree.content.analysis.video.model.VideoValidityResponse;
...
public class VideoContentAnalysisResourceController {
    ...
    public @ResponseBody
    ResponseEntity<VideoSafetyResponse> isVideoSafe(@RequestParam String imageURI) {
        boolean isSafe = contentAnalyser.isVideoSafe();
